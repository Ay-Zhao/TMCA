...
def parse_input():
    ...
    parser.add_argument('--dataset', type=str, default='sider', help='Name of dataset')
    ...
    parser.add_argument('--n_tasks', type=int, default=27, help='Number of label')
    ...
    parser.add_argument('--freeze_epoch', type=int, default=0, help='freeze from 0 - target number epoch for certain model part')
    parser.add_argument('--fuse_mechanism', type=str, default='plus', help='concat or concatenation')
    parser.add_argument(
        "--enabled_modality",
        nargs="+",
        default=["1d", "2d", "3d"],
        choices=["1d", "2d", "3d"],
        help="Enabled modalities for ablation"
    )
    parser.add_argument(
        "--target_task",
        type=int,
    ...
    parser.add_argument(
        ...
        type=str,
        default="symmetric",
        choices=["chain", "symmetric", "bottleneck", "gated", "hierarchical", "mma"],
        help=(
            "Three-modality fusion strategy (only used when enabled_modality='1d 2d 3d' "
            "and fuse_mechanism='crossattn'). "
            "Options: chain | symmetric | bottleneck | gated | hierarchical | mma"
        )
    )
